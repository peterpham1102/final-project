...
class Chatbot extends Component {
    ...
    renderCards(cards) {
        return cards.map((card, i) => <CardChatbot key={card.structValue.key} payload={card.structValue} />);
    }
    renderOneMessage(message, i) {
        ...
        // } 
                ...
                <div className="card-panel grey lighten-5 z-depth-1">
                    <div style={{ overflow: 'hidden' }}>
                        ...
                        <div style={{ overflow: 'auto', overflowY: 'scroll' }}>
                            <div style={{ height: 256, width: message.msg.payload.fields.cards.listValue.values.length * 234 }}>
            ...
            return <QuickReplies
                text={message.msg.payload.fields.text ? message.msg.payload.fields.text : "OK"}
                key={i}
                replyClick={this._handleQuickReplyPayload}
                speaks={message.speaks}
                payload={message.msg.payload.fields.quick_replies.fields.quick_replies.listValue.values} />;
        }
    }
    ...
    render() {
        ...
        // console.log("type: ", typeof(this.state.messages))
